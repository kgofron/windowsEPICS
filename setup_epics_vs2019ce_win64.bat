...
set PATH=C:\epics\bin\;C:\Strawberry\perl\bin;C:\epics\base\bin;%PATH%
...
rem"C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x86_amd64
REM
